<div class="debugpress_sidebar">
    ...
    <div class="debugpress_help">
        ...
        <hr/>
        <p><?php esc_html_e( 'The plugin is available on GitHub, and you can report issues, suggest new features or submit pull requests.', 'debugpress' ); ?></p>
        <div>
            <a target="_blank" rel="noopener" href="https://github.com/dev4press/debugpress"><?php esc_html_e( 'DebugPress on GitHub', 'debugpress' ); ?></a>
        </div>
    </div>
